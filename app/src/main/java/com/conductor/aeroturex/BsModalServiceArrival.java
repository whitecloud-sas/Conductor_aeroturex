...
public class BsModalServiceArrival extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //TextView direccionView = v.findViewById(R.id.bs_m_sa_direccion);
        //direccionView.setText(MainActivity.v_direccion_servicio);

        TextView infoAdicionalView = v.findViewById(R.id.bs_m_sa_aditional_info);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        // Buttons
        Button btnBack = view.findViewById(R.id.btn_actions);
