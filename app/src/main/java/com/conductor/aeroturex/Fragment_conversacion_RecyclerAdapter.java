...
class Fragment_conversacion_RecyclerAdapter extends RecyclerView.Adapter <RecyclerView.ViewHolder>  {
    ...
    private List<String> mDataSetFecha = new ArrayList<>();
    ...
    Fragment_conversacion_RecyclerAdapter(Context context, List<String> Origen, List<String> dataSetInfo, List<String> dataSetId, List<Integer> dataSetMe,Fragment_conversacion.On_Fragment_mensaje_Listener communication,List<String> dataSetFecha) {
        mDataSet = Origen;
        mDataSetInfo = dataSetInfo;
        mDataSetId = dataSetId;
        mDataSetMe = dataSetMe;
        mDataSetFecha = dataSetFecha;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder h, int position) {
        ...
        if (mDataSet != null && 0 <= position && position < mDataSet.size()) {
            ...
            String fecha = mDataSetFecha.get(position);
            ...
            // Bind your data here
            holder.bind(data, info, id, me, fecha);
        }
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        void bind(final String content, final String details, final String id, final int me, final String fecha) {
