...
public class ProfileFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if(view!=null) {
            ...
            TextView tv_conductor_nombre = (TextView) view.findViewById(R.id.tvconductor_nombre);
            ...
            CircleImageView profile_pic = (CircleImageView) view.findViewById(R.id.profile_pic);
