...
import com.whitecloud.hm.whiteclouduser.DireccionesFragment.OnListFragmentInteractionListener;
...
public class DireccionesItemRecyclerViewAdapter extends RecyclerView.Adapter<DireccionesItemRecyclerViewAdapter.ViewHolder> {
    ...
    public DireccionesItemRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
