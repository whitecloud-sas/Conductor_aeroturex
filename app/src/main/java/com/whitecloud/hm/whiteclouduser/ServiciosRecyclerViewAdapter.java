...
import com.whitecloud.hm.whiteclouduser.ServiciosFragment.OnListFragmentInteractionListener;
import com.whitecloud.hm.whiteclouduser.dummy.DummyContentServicios.DummyItem;
...
class ServiciosRecyclerViewAdapter extends RecyclerView.Adapter<ServiciosRecyclerViewAdapter.ViewHolder> {
    ...
    ServiciosRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
